...
class User extends CActiveRecord
{
	...
	public function scopes()
    {
        return array(
            ...
            'notsafe'=>array(
            	'select' => 'id, username, password, email, activkey, createtime, lastvisit, superuser, status, center',
            ),
        );
    }
    ...
    {
        return array(
            'select' => 'id, username, email, createtime, lastvisit, superuser, status, center',
        );
    }
