  ...
  $(document).ready(function() {
	...
	var matches = 0;
      $('div').each(function(index, value){
        ...
        {
            //alert("first"+matches);
          var size=$("#StudentJersy_"+matches+"_size_id").val();
          var color=$("#StudentJersy_"+matches+"_color_id").val();
          var brand=$("#StudentJersy_"+matches+"_brand_id").val();
          ...
          if(size !="" && color !="" && brand !="")
            ...
            $.ajax({
                       ...
                       success: function(data) {
                              ...
                              if(data==1){
                                $("#avl"+matches).val("Jersy Available ");
                                matches++;
                              }
                              else
                              {
                                $("#avl"+matches).val("Jersy Not Available");
                                matches++;  
                                //alert("else="+matches)  
                                }
                             // alert("Success")                                          
    ...
    $('select.mysize').on('change', function(e) {
          ...
          var color=$("#StudentJersy_"+id+"color_id").val();
          var brand=$("#StudentJersy_"+id+"brand_id").val();
...
<div class="row">
  ...
  <div class="col-xs-12">                      
   ...
   <p id="jerror" style="color:red;font-size:15px;">  </p>   
    ...
    <?php echo $form->dropDownList($model,"student_id",StudentKit::model()->getStudentId(),array('empty'=>'Select','required'=>'required','class'=>'form-control')); ?>
