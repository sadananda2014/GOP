...
$mandrill = new Mandrill('TkY1C36IpIl7GFtJEDAr6w');
 //$email="amit@gameonsports.in";
 //$name="Amit";
try{
 
        $message = array(
                'subject' => 'Payment due date is approaching - Roots Football School',
                  ...
                  <td style="font-size:12px; font-family: Helvetica,Arial,sans-serif;"><table width="100%" border="0" cellspacing="0" cellpadding="10" >
                      <tr>
                        <td style="font-size:16px; font-family: Helvetica,Arial,sans-serif; padding-left:20px">
                                 Football coaching fee of Rs. '.$row['total_fee'].' for next '.$row['duration'].' months for '.$row['name']." ".$row['last_name'].' is due on <span style="color:red">'.$row['payment_due_date'].'</span>. Kindly request you to ensure timely payment of the due amount.
